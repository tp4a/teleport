...
<%block name="extend_js_file">
    <script type="text/javascript" src="${ static_url('js/asset/account-group-list.js') }"></script>
</%block>
    ...
    <div class="box">
        <div class="table-prefix-area">
            <div class="table-extend-cell">
                <span class="table-name"><i class="fa fa-list fa-fw"></i> 账号分组列表</span>
            ...
            <div class="table-extend-cell table-extend-cell-right group-actions">
                <button id="btn-create-group" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle fa-fw"></i> 创建账号分组</button>
            </div>
        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-4">
                                <input id="edit-group-name" type="text" class="form-control" placeholder="账号分组名称"/>
                            </div>
                            <div class="col-sm-6">
